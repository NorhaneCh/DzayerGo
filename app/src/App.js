    ...
    <div className=" pt-0 align-center">
      <div id="hero" className="bg relative">
        ...
        <div className="flex flex-col mt-16 justify-center items-center">
          <p className="text-[45px] font-bold  text-dzayergo-white">
      ...
      <div id="start" className=" relative flex flex-row gap-36 mt-36 justify-center">
        ...
        <div>
          ...
          Great news! Our application is intended for everyone without exception, available in 3 languages.
        </p>
        </div>
      </div>
      ...
      <div className="w-[70%] pl-20">
          ...
          <p className="text-[25px] w-[90%] mt-12 text-justify">Specialized in digital services since its appearance in 2012, we are committed to offering innovative and high-quality solutions to our clients. With a talented team equipped with undeniable skills, we are capable of tackling the most complex challenges.
        </p>
        </div>
      ...
      <div id="download" className=" relative mt-28">
        ...
        <p className="text-dzayergo-black text-[40px] text-center font-medium mt-9">
        Download our mobile application
        </p>
        <p className="text-dzayergo-pink text-[40px] text-center font-bold ">
        DzayerGO
        </p>

        <Slider className="slider" {...settings}>
        <div>
              <img className="h-[500px]" src={frame1} alt="" />
            </div>
            <div>
              <img className="h-[500px]" src={frame2} alt="" />
            </div>
            <div>
              <img className="h-[500px]" src={frame3} alt="" />
            </div>
            <div>
              <img className="h-[500px]" src={frame4} alt="" />
            </div>
            <div>
              <img className="h-[500px]" src={frame5} alt="" />
            </div>
            <div>
              <img className="h-[500px]" src={frame6} alt="" />
            </div>
  </Slider>

  </div>
      <div
        className="relative bg-dzayergo-purple h-[200px] pt-6 mt-36"
      >
